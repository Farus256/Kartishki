...
export default defineConfig({
  ...
  webServer: { command: 'npm run dev -w @kartishki/client -- --host 127.0.0.1 --port 5180', url: 'http://127.0.0.1:5180', reuseExistingServer: false, env: { ...process.env, VITE_SERVER_URL: 'http://backend.test:2567' } },
});
