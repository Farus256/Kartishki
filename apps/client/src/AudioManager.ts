...
const files = {
  ...
  ab_poison: 'impactGlass_medium_002', ab_death: 'impactSoft_heavy_001', ab_summon: 'impactWood_medium_001', ab_deathrattle: 'impactMining_001', ab_reborn: 'bong_001', ab_windfury: 'scratch_003', ab_clash: 'impactMetal_heavy_003', ab_stamp: 'minimize_006', ab_tally: 'pluck_002',
} as const;
