...
const TRIGGER: Record<AutoBattlerEffectTrigger, [string, string]> = {
  ...
  play: ['Когда вы играете существо', 'When you play a minion'],
  buy: ['После покупки', 'After you buy a minion'],
  sell: ['При продаже', 'When sold'],
  endTurn: ['В конце хода', 'At the end of your turn'],
  triple: ['При тройке', 'When you make a triple'],
  startCombat: ['В начале боя', 'At the start of combat'],
