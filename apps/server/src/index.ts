...
import { devAccountPassword, seedDevAccount } from './devAccount';
...
if (await seedDevAccount(players)) console.log(`[dev] local test account "dev" seeded (password: ${devAccountPassword()})`);
