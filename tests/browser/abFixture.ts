...
export function abFixture():AbSnapshot{
 ...
 return{status:'online',phase:'RECRUIT_PHASE',turn:8,revision:1,recruitSeconds:35,heroSeconds:0,sessionId:'p0',error:'',winnerId:'',anomalyId:'',players,catalog:starterAutoBattlerCatalog,heroOffers:[],discover:null,combat:null,combatBoards:null,pairing:[]};
}
