...
export default defineConfig({
  testDir: './tests/browser', testMatch: ['game.spec.ts', 'photo-editor.spec.ts', 'portrait-refresh.spec.ts', 'heroes.spec.ts', 'battlegrounds.spec.ts', 'ab-dnd.spec.ts', 'ab-composition.spec.ts', 'battlegrounds-editor.spec.ts', 'server-browser.spec.ts'], workers: 1, timeout: 60000,
